...
export const rootRouterConfig: Routes = [
 ...
 { path: 'alerta', component: AlertaLogueoComponent},
  ...
  { path: 'ABMGESTION', component: AbmGestionComponent  ,canActivate:[AuthGuard]},
  ...
  { path: 'instalaciones', component: InstalacionComponent ,canActivate:[AuthGuard]},
